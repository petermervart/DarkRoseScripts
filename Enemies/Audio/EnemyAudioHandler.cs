...
public class EnemyAudioHandler : MonoBehaviour, IEnemyAudioHandler
{
    [SerializeField]
    ...
    public void OnHitImpact() // In future remove this and make surface particle and sound system
    {
